...
export const article = pgTable.withRLS(
  'article',
  {
    id: serial().primaryKey(),
    feedId: integer()
...
export const behaviorEnum = pgEnum('behavior', ['click', 'read', 'favorite', 'share'])

export const userBehavior = pgTable.withRLS(
  'user_behavior',
  {
    id: serial().primaryKey(),
    userId: uuid()
...
export const userFavorite = pgTable.withRLS(
  'user_favorite',
  {
    userId: uuid()
      .references(() => user.id, { onDelete: 'cascade' })
...
export const userRecommendation = pgTable.withRLS(
  'user_recommendation',
  {
    userId: uuid()
      .references(() => user.id, { onDelete: 'cascade' })
